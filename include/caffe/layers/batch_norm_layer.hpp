...
class BatchNormScaleShiftLayer : public Layer<Dtype> {
 public:
  explicit BatchNormScaleShiftLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BatchNormScaleShift"; }
...
template <typename Dtype>
class BatchNormKyleLayer : public Layer<Dtype> {
 public:
  explicit BatchNormKyleLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "BatchNormKyle"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }

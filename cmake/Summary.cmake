...
function(caffe_print_configuration_summary)
  ...
  if(HAVE_PYTHON)
    caffe_status("Python:")
    caffe_status("  Interpreter       :" Python3_EXECUTABLE THEN "${Python3_EXECUTABLE} (ver. ${Python3_VERSION})" ELSE "No")
    caffe_status("  Libraries         :" Python3_Development.Module_FOUND  THEN "${Python3_LIBRARIES} (ver ${Python3_VERSION})" ELSE "No")
    caffe_status("  NumPy             :" Python3_NumPy_FOUND  THEN "${Python3_NumPy_INCLUDE_DIRS} (ver ${Python3_NumPy_VERSION})" ELSE "No")
    caffe_status("")
  endif()
  if(BUILD_matlab)
    caffe_status("Matlab:")
